...
fun getCustomers(): ArrayList<Customer> {
    ...
    ret.add(Customer(20, "Briggs", "Puckett", "Bicol", "briggs.puckett@bicol.co.uk", 18, GregorianCalendar(2015,11,9), true, R.drawable.briggs))
    ...
    ret.add(Customer(200, "Cornelia", "Peck", "Tubalum", "cornelia.peck@tubalum.me", 10, GregorianCalendar(2017,11,29), true, R.drawable.cornelia))
    ret.add(Customer(201, "Farrell", "Ballard", "Kongene", "farrell.ballard@kongene.us", 7, GregorianCalendar(2018,7,16), false, R.drawable.farrell))
    ret.add(Customer(202, "Carlene", "Galloway", "Cytrek", "carlene.galloway@cytrek.biz", 17, GregorianCalendar(2014, 6,15), false, R.drawable.carlene))
    ret.add(Customer(203, "Cherry", "Vaughan", "Corporana", "cherry.vaughan@corporana.co.uk", 19, GregorianCalendar(2014,5,29), false, R.drawable.cherry))
    ret.add(Customer(204, "Baxter", "Wolfe", "Gaptec", "baxter.wolfe@gaptec.ca", 19, GregorianCalendar(2015,10,18), false, R.drawable.baxter))
